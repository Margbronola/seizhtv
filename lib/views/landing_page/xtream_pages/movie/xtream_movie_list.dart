...
class XtreamMovieListPage extends StatefulWidget {
  const XtreamMovieListPage({
    super.key,
  ...
  @override
  State<XtreamMovieListPage> createState() => XtreamMovieListPageState();
}

class XtreamMovieListPageState extends State<XtreamMovieListPage> {
              ...
              ? searchData!.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, i) {
                          final XtreamDataModel d = searchData![i];
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData && !snapshot.hasError) {
                          if (snapshot.data!.isNotEmpty) {
                            ...
                            for (final XtreamDataModel movdata in widget.data) {
                              for (final TopMovieModel toprated in result) {
                                if (movdata.name == toprated.title) {
