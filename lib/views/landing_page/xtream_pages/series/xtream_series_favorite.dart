...
class XtreamSeriesFavoritePage extends StatefulWidget {
  ...
  @override
  State<XtreamSeriesFavoritePage> createState() =>
      XtreamSeriesFavoritePageState();
}

class XtreamSeriesFavoritePageState extends State<XtreamSeriesFavoritePage> {
  String searchText = "";
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      ...
                      //   context,
                      //   PageTransition(
                      //     child: XtreamSeriesDetailsPage(data: item, title: result2),
