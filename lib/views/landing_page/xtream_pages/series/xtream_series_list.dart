...
import 'xtream_series_details.dart';

class XtreamSeriesListPage extends StatefulWidget {
  const XtreamSeriesListPage({
    super.key,
  ...
  final List<XtreamSeriesDataModel> data;
  final bool showSearchField;
  final ValueChanged<M3uEntry> onUpdateCallback;

  @override
  State<XtreamSeriesListPage> createState() => XtreamSeriesListPageState();
}

class XtreamSeriesListPageState extends State<XtreamSeriesListPage> {
  ...
  List<XtreamSeriesDataModel>? searchData;
  ...
  late List<XtreamSeriesDataModel> _displayData = List.from(
