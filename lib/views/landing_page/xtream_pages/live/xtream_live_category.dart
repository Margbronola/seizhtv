...
class XtreamLiveCategoryPage extends StatefulWidget {
  ...
  final List<XtreamDataModel> category;
  late bool showsearchfield;
  final ValueChanged<XtreamDataModel> onUpdateCallback;

  @override
  State<XtreamLiveCategoryPage> createState() => XtreamLiveCategoryPageState();
}

class XtreamLiveCategoryPageState extends State<XtreamLiveCategoryPage> {
          ...
          child: searchText != "" && _displayData.isEmpty
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print("DATA LENGHT: ${widget.category.length}");
